...
*/
public class sync_WaitNotify {
	public static void main(String[] args) {
		WorkObject workObj = new WorkObject();
		
		ThreadA tA = new ThreadA(workObj);
		ThreadB tB = new ThreadB(workObj);
...
class WorkObject {
	public synchronized void methodA() {
		System.out.println("methodA() working..");
	...
	public synchronized void methodB() {
		System.out.println("methodB() working..");
...
//WorkObject methodB()메서드만 호출하는 Thread 
