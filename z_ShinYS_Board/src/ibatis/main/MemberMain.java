...
public class MemberMain {
	// Service객체 변수를 선언한다.
	private BoardServiceImpl memService;
	...
	public MemberMain(){
		memService = BoardServiceImpl.getInstance();  // service객체 생성
...
//	}
	...
	public void displayMemberAll(){
		...
		if(memList.size()==0){
			...
			for(BoardVO mvo : memList){
				System.out.println(mvo.getBoard_no() + "   " + mvo.getBoard_title() + "   " 
					+ "  " + mvo.getBoard_content());
			}
		}
...
//       ArrayList<BoardVO> memList = 
//             (ArrayList<BoardVO>) memService.getSearchMember(mv);
//       
//       System.out.println();
//       System.out.println("----------------------------------------");
//       System.out.println(" ID     이 름       전화번호        주  소");
