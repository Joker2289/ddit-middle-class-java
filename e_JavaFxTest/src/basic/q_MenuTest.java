...
public class q_MenuTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		MenuItem exitMenuItem = new MenuItem("Exit"); //주메뉴
		...
		RadioMenuItem msssqlItem = new RadioMenuItem("MS-SQL");
		msssqlItem.setToggleGroup(tGroup);
		
		sqlMenu.getItems().addAll(mysqlItem, oracleItem, msssqlItem);
