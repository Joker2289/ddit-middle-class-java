...
public class RemoteClient {
	public static void main(String[] args) {
		...
		try {
			...
			//이제부터는 불러온 객체의 메서드를 호출해서 사용할 수 없다
			//안녕하세요 에대한 length 값 리턴
			...
			files[0] = new File("/Users/pjk/Documents/IO_test/Japan8.jpg");
			files[1] = new File("/Users/pjk/Documents/IO_test/dd.txt");
